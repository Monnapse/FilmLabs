...
import { Play, Loader2, CheckCircle } from "lucide-react"; // Changed PlayCircle to Play
                  ...
                  >
                    <div className="relative aspect-video w-full bg-[#0d0d0d]">
                      {ep.still_path ? (
                        ...
                        <div className="absolute inset-0 flex items-center justify-center text-white/30 font-bold text-sm">No Image</div>
                      )}
                      
                      {/* FIXED SLEEK PLAY BUTTON */}
                    ...
                    <div className="p-4 border-t border-white/5">
                      ...
                      <p className="text-white/50 text-xs line-clamp-2 leading-relaxed">{ep.overview || "No description available."}</p>
                    </div>
                  </div>
                );
              })}
